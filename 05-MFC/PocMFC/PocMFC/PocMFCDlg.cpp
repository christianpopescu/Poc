...
// PocMFCDlg.cpp : implementation file
//
...
{
	//Model.Output(_T(""));
	Model = std::make_unique<PocMFCDlgModel>();
...
// CPocMFCDlg message handlers

BOOL CPocMFCDlg::OnInitDialog()
{
...
void CPocMFCDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CPocMFCDlg::OnQueryDragIcon()
{
